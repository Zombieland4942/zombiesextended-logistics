...
transport_belts = {
    { order = "a-a", name = "transport-belt-mk1", health = 200, speed = 0.125, next_upgrade = "transport-belt-mk2", ingredients = { {"express-transport-belt", 2},{"vibranium-plate", 2} }, technology = "high-teir-logistics-mk1" },
    { order = "a-b", name = "transport-belt-mk2", health = 230, speed = 0.1875, next_upgrade = "", ingredients = { {"transport-belt-mk1", 2},{"vibranium-plate", 5} }, technology = "high-teir-logistics-mk2" },
}

underground_belts = {
    { order = "b-a", name = "underground-belt-mk1", health = 200, speed = 0.125, reach = 18, belt_name = "transport-belt-mk1", next_upgrade = "underground-belt-mk2", ingredients = { {"express-underground-belt", 2},{"vibranium-plate", 2} }, technology = "high-teir-logistics-mk1" },
    { order = "b-b", name = "underground-belt-mk2", health = 230, speed = 0.1875, reach = 36, belt_name = "transport-belt-mk2", next_upgrade = "", ingredients = { {"underground-belt-mk1", 2},{"vibranium-plate", 5}}, technology = "high-teir-logistics-mk2" },
}

splitters = {
    { order = "c-a", name = "splitter-mk1", health = 200, speed = 0.125, belt_name = "transport-belt-mk1", next_upgrade = "splitter-mk2", ingredients = { {"express-splitter", 2},{"vibranium-plate", 2} }, technology = "high-teir-logistics-mk1" },
    { order = "c-b", name = "splitter-mk2", health = 230, speed = 0.1875, belt_name = "transport-belt-mk2", next_upgrade = "", ingredients = { {"splitter-mk1", 2},{"vibranium-plate", 5} }, technology = "high-teir-logistics-mk2" },
}
...
fast_inserters = {
    { order = "a-a", name = "fast-inserter-mk1", health = 180, speed = 0.08, energy_KJ = 14, energy_drain_kw = 1, next_upgrade = "fast-inserter-mk2", ingredients = { {"fast-inserter", 2},{"complex-processing-unit", 2} }, technology = "high-teir-inserters-mk1" },
    { order = "a-b", name = "fast-inserter-mk2", health = 200, speed = 0.16, energy_KJ = 28, energy_drain_kw = 2, next_upgrade = "", ingredients = { {"fast-inserter-mk1", 2},{"complex-processing-unit", 5} }, technology = "high-teir-inserters-mk2" },
}

fast_filter_inserters = {
    { order = "b-a", name = "fast-filter-inserter-mk1", health = 180, speed = 0.08, energy_KJ = 14, energy_drain_kw = 1, next_upgrade = "fast-filter-inserter-mk2", ingredients = { {"filter-inserter", 1},{"fast-inserter", 1},{"complex-processing-unit", 2} }, technology = "high-teir-inserters-mk1" },
    { order = "b-b", name = "fast-filter-inserter-mk2", health = 200, speed = 0.16, energy_KJ = 28, energy_drain_kw = 2, next_upgrade = "", ingredients = { {"fast-filter-inserter-mk1", 2},{"complex-processing-unit", 5} }, technology = "high-teir-inserters-mk2" },
}

fastlong_inserters = {
    { order = "c-a", name = "fastlong-inserter-mk1", health = 180, speed = 0.04, energy_KJ = 10, energy_drain_kw = 0.7, next_upgrade = "fastlong-inserter-mk2", ingredients = { {"long-handed-inserter", 1},{"fast-inserter", 1},{"complex-processing-unit", 2} }, technology = "high-teir-inserters-mk1" },
    { order = "c-b", name = "fastlong-inserter-mk2", health = 200, speed = 0.08, energy_KJ = 15, energy_drain_kw = 1, next_upgrade = "", ingredients = { {"fastlong-inserter-mk1", 2},{"complex-processing-unit", 5} }, technology = "high-teir-inserters-mk2" },
}

stack_inserters = {
    { order = "a-a", name = "stack-inserter-mk1", health = 190, speed = 0.08, energy_KJ = 30, energy_drain_kw = 2, next_upgrade = "stack-inserter-mk2", ingredients = { {"stack-inserter", 2},{"complex-processing-unit", 2} }, technology = "high-teir-inserters-mk1" },
    { order = "a-b", name = "stack-inserter-mk2", health = 210, speed = 0.16, energy_KJ = 40, energy_drain_kw = 4, next_upgrade = "", ingredients = { {"stack-inserter-mk1", 2},{"complex-processing-unit", 5} }, technology = "high-teir-inserters-mk2" },
}

stack_filter_inserters = {
    { order = "b-a", name = "stack-filter-inserter-mk1", health = 190, speed = 0.08, energy_KJ = 30, energy_drain_kw = 2, next_upgrade = "stack-filter-inserter-mk2", ingredients = { {"stack-filter-inserter", 1},{"stack-inserter", 1},{"complex-processing-unit", 5} }, technology = "high-teir-inserters-mk1" },
    { order = "b-b", name = "stack-filter-inserter-mk2", health = 210, speed = 0.16, energy_KJ = 40, energy_drain_kw = 4, next_upgrade = "", ingredients = { {"stack-filter-inserter-mk1", 2},{"complex-processing-unit", 2} }, technology = "high-teir-inserters-mk2" },
}
...
offshore_pumps = {
    { order = "c-a", name = "offshore-pump-mk1", health = 150, pumping_size = 40, next_upgrade = "offshore-pump-mk2", ingredients = { {"offshore-pump", 2} }, technology = "fluid-handling-mk1" },
    { order = "c-b", name = "offshore-pump-mk2", health = 300, pumping_size = 60, next_upgrade = "", ingredients = { {"offshore-pump-mk1", 2} }, technology = "fluid-handling-mk2" },
}
...
chests = {
    { order = "a-a", name = "chest-mk1", health = 400, inventory_size = 70, next_upgrade = "chest-mk2", ingredients = { {"gold-plate", 2} } },
    { order = "a-b", name = "chest-mk2", health = 600, inventory_size = 96, next_upgrade = "", ingredients = { {"vibranium-plate", 2} } },
}
...
storage_tanks = {
    { order = "b-a", name = "storage-tank-mk1", health = 800, fluid_size = 1000, pipe_covers = goldpipecovers(), next_upgrade = "storage-tank-mk2", ingredients = { {"gold-plate", 20} }, technology = "fluid-handling-mk1" },
    { order = "b-b", name = "storage-tank-mk2", health = 1600, fluid_size = 3000, pipe_covers = darkpipecovers(), next_upgrade = "", ingredients = { {"vibranium-plate", 20} }, technology = "fluid-handling-mk2" },
}

pipes = {
    { order = "c-a", name = "pipe-mk1", health = 300, next_upgrade = "pipe-mk2", ingredients = { {"gold-plate", 2} }, technology = "fluid-handling-mk1" },
    { order = "c-b", name = "pipe-mk2", health = 600, next_upgrade = "", ingredients = { {"vibranium-plate", 2} }, technology = "fluid-handling-mk2" },
}

pipe_to_grounds = {
    { order = "d-a", name = "pipe-to-ground-mk1", health = 300, distance = 20, pipe_covers = goldpipecovers(), next_upgrade = "pipe-to-ground-mk2", ingredients = { {"pipe-mk1",5},{"gold-plate",2} }, technology = "fluid-handling-mk1" },
    { order = "d-b", name = "pipe-to-ground-mk2", health = 600, distance = 40, pipe_covers = darkpipecovers(), next_upgrade = "", ingredients = { {"pipe-mk2",5},{"vibranium-plate",2} }, technology = "fluid-handling-mk2" },
}